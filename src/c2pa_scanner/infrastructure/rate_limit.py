...
der Server schnell, feuert der Scanner entsprechend schnell nach. Bei einer
grossen Sitemap entstehen so mehrere hundert Requests pro Minute; mit aktivem
Browser-Rendering laeuft zudem jeder Aufruf an den Zwischenspeichern des
Servers vorbei und erzeugt ein Vielfaches der Last eines normalen Besuchers.
