...
Der Import allein beweist gar nichts: bei ``import c2pa_scanner.__main__``
...
Genau daran ist v0.3.0 vorbeigelaufen: der Startblock stand mitten in der
Datei, vor den Funktionen, die ``main()`` als Erstes aufruft. Die gesamte
Testsuite blieb gruen, waehrend ``python -m c2pa_scanner`` mit einem
